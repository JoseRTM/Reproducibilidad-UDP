...
format:
  revealjs:
    theme: beige
    slide-number: true
    transition: fade       # transición entre diapositivas
    highlight-style: a11y
    center: false
    incremental: true      # bullets aparecen uno a uno con fade-in
lang: es
editor: visual
---
...
| Uso típico | Informes rápidos en RStudio | Sitios, presentaciones, libros |
